...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeoMetadata.view_name'
        db.add_column(u'painlessseo_seometadata', 'view_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SeoMetadata.view_name'
        db.delete_column(u'painlessseo_seometadata', 'view_name')
